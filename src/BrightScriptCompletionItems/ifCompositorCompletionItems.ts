...
export const ifCompositorCompletionItems: CompletionItem[] = [
    {
        ...
        detail: 'SetDrawTo(destBitmap as Object, rgbaBackground as Integer) as Void',
...
`
    ...
    },
    {
        ...
        detail: 'NewSprite(x as Integer, y as Integer, region as Object, z as Integer) as Object',
        documentation: new vscode.MarkdownString(
`
...
`
    ...
    },
    {
        ...
        detail: 'NewAnimatedSprite(x as Integer, y as Integer, regionArray as Object, z as Integer) as Object',
        documentation: new vscode.MarkdownString(
`
Returns an roSprite object.
...
`
    ...
    },
    {
        ...
        detail: 'AnimationTick(duration as Integer) as Void',
        documentation: new vscode.MarkdownString(
`
...
`
    ...
    },
    {
        ...
        detail: 'ChangeMatchingRegions(oldRegion as Object, newRegion as Object) as Void',
        documentation: new vscode.MarkdownString(
`
