...
### Changed
 - The name of the beta program to `languageserver-beta[whatever]` instead of a full version in the front, which removes some confusion around the naming scheme. This release is the successor to `1.9.0-beta11`.
