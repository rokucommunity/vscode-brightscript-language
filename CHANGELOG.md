...
### Added
 - Add roku-test-automation to local dev scripts and workspace ([#880](https://github.com/rokucommunity/vscode-brightscript-language/pull/880))
...
### Changed
 ...
 - upgrade to [roku-test-automation@3.0.0-alpha.1](https://github.com/rokucommunity/roku-test-automation/blob/master/CHANGELOG.md#300-alpha1---2026-08-28). Notable changes since 2.2.2:
     ...
     - chore: Simplify create-vsix inputs and improve branch resolution ([#174](https://github.com/rokucommunity/roku-test-automation/pull/174))
     - chore: Give fork PRs a clear create-vsix failure message ([#173](https://github.com/rokucommunity/roku-test-automation/pull/173))
     ...
     - chore: Update create-vsix to support multi-vsix and shared bot logic ([#170](https://github.com/rokucommunity/roku-test-automation/pull/170))
     ...
     - chore: update repository links for rokucommunity adoption ([#157](https://github.com/rokucommunity/roku-test-automation/pull/157))
### Fixed
 ...
 - Fixed: Carry the picked device config through the rekey and package flows ([#875](https://github.com/rokucommunity/vscode-brightscript-language/pull/875))
...
### Added
 ...
 - Support setting a default device password ([#764](https://github.com/rokucommunity/vscode-brightscript-language/pull/764))
### Changed
 - Auto-update imports in brs|bs|xml when files are renamed ([#776](https://github.com/rokucommunity/vscode-brightscript-language/pull/776))
 - Device credentials refactor: SN-keyed passwords and smart resolution ([#772](https://github.com/rokucommunity/vscode-brightscript-language/pull/772))
 - Only keep most recent IP address per serial per network ([#770](https://github.com/rokucommunity/vscode-brightscript-language/pull/770))
 - defaultDevicePassword scoped only to global settings ([#771](https://github.com/rokucommunity/vscode-brightscript-language/pull/771))
 - Prefer active device for ${promptForHost}, fall back to picker ([#765](https://github.com/rokucommunity/vscode-brightscript-language/pull/765))
 - Skip health checks when opening device picker ([#757](https://github.com/rokucommunity/vscode-brightscript-language/pull/757))
 ...
 - upgrade to [brighterscript-formatter@1.7.24](https://github.com/rokucommunity/brighterscript-formatter/blob/master/CHANGELOG.md#1724---2026-04-30). Notable changes since 1.7.23:
 - upgrade to [roku-debug@0.23.6](https://github.com/rokucommunity/roku-debug/blob/master/CHANGELOG.md#0236---2026-04-30). Notable changes since 0.23.5:
...
### Fixed
 - Fix getIpForSerial fallback to select most recently updated IP across networks ([#769](https://github.com/rokucommunity/vscode-brightscript-language/pull/769))
 - Fix network change detection on wake from sleep ([#760](https://github.com/rokucommunity/vscode-brightscript-language/pull/760))
...
### Added
 ...
 - BrightScript syntax highlighting for CDATA blocks in Roku XML files ([#729](https://github.com/rokucommunity/vscode-brightscript-language/pull/729))
### Changed
 - Populate additionalInfo fields in DAP crash issue reporter ([#735](https://github.com/rokucommunity/vscode-brightscript-language/pull/735))
...
### Fixed
 - Errors in extension host output ([#727](https://github.com/rokucommunity/vscode-brightscript-language/pull/727))
 - Make the host picker less squishy ([#731](https://github.com/rokucommunity/vscode-brightscript-language/pull/731))
 - Crash in debugger in _syncBreakpoints when client is undefined ([#316](https://github.com/rokucommunity/roku-debug/pull/316))
...
### Added
 ...
 - Added missing @type/request dev dependency ([#713](https://github.com/rokucommunity/vscode-brightscript-language/pull/713))
### Changed
