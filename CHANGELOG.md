...
### Changed
 - Roku Cloud Emulator support ([#861](https://github.com/rokucommunity/vscode-brightscript-language/pull/861))
 - Migrate to roku-deploy v4 ([#860](https://github.com/rokucommunity/vscode-brightscript-language/pull/860))
 - Security enhancements ([#869](https://github.com/rokucommunity/vscode-brightscript-language/pull/869))
...
### Fixed
 - fix: Prevent stale keep-alive sockets from failing create-vsix ([#868](https://github.com/rokucommunity/vscode-brightscript-language/pull/868))
